...
class RutaDiariaComercioController extends Controller
{
    ...
    {
        $searchModel = new RutaDiariaComercioSearch();
    ...
    /**
     * Finds the RutaDiariaComercio model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RutaDiariaComercio the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RutaDiariaComercio::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
     * Updates an existing RutaDiariaComercio model.
    ...
    /**
     * Deletes an existing RutaDiariaComercio model.
