    ...
    <section class="sidebar">
        ...
        Nav::widget(
            [
                ...
                'items' => [
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Categorias').'</span>', 'url' => ['/categoria']],
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Comercios').'</span>', 'url' => ['/comercio']],
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Productos comercio').'</span>', 'url' => ['/comercio-productos-relacionados']],
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Productos').'</span>', 'url' => ['/producto']],
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Rutas').'</span>', 'url' => ['/ruta']],
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Administrar Usuarios').'</span>', 'url' => ['/user/admin']],
