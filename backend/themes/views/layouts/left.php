    ...
    <section class="sidebar">
        ...
        Nav::widget(
            [
                ...
                'items' => [
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Categories').'</span>', 'url' => ['/categoria']],
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Stores').'</span>', 'url' => ['/comercio']],
                    ['label' => '<i class="fa fa-users"></i><span>'. Yii::t('app','Store Products').'</span>', 'url' => ['/comercio-productos-relacionados']],
